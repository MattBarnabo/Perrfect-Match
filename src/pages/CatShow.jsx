    ...
    <div className='page-body'>
        <div className="show-profile">
          <ul className="show-text">
            ...
            <li>
              <NavButton url={`/cat-edit/${cat.id}`} buttonContent= {`Edit ${cat.name}`}
              className="show-button"
              >
              </NavButton>
            </li>
            <li>
              <button onClick={handleDeleteCat(cat.id)} className="nav-button show-button"
              >
                Delete {cat.name}
              </button>
            </li>
            <li>
              <NavButton url={"/cat-index"} buttonContent= {`Back to all cats`}
              className="show-button"
              >
              </NavButton>
            </li>
